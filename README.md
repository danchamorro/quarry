...
safe Save and Save As. Save replaces the current regular file only after a
same-directory temporary file is flushed and synced; Save As leaves the
previous source unchanged. Direct cell editing is next.
